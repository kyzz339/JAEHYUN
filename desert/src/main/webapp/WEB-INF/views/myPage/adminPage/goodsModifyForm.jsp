...
<body>
    ...
    <form style="margin: 20px" action="/GoodsModify" method="post" enctype="multipart/form-data">
        <table > <!-- 전체 윤곽-->
            <tr>
                <tr>
                    <td>
                    ...
                    <tr>
                        <td>
                            <div class="input-group mb-1">
                                ...
                                <input type="text" name="price" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"value="${goods.price}">
                            </div>
                        </td>
                    </tr>
<%--                    <tr>--%>
...
<%--                    --%>
                    <tr>
                        <td>
                            <div class="input-group mb-1">
                                ...
                                <textarea name="contents" class="form-control" aria-label="width textarea">${goods.contents}</textarea>
                            </div>
                        </td>
                    </tr>
                    <tr>
        ...
        <button type="submit" class="btn btn-outline-secondary" >등록</button>
            <a href="goodsRegList"><button type="button" class="btn btn-outline-secondary" >취소</button></a>
